...
export class TrackService {
  ...
  public generateTrackPool(): void {
    ...
    if (this.useCTGPDX.value) {
      ...
      this.tracks.push(new Track("GPDX", "DK Jungle", 101, 120.7, "Jungle", "Penguin", "GP"));
      this.tracks.push(new Track("N64", "Frappe Snowland", 102, 26, "Snow", "Penguin", "Flower"));
      this.tracks.push(new Track("3DS", "Mario Circuit", 103, 110, "Circuit", "Penguin", "Flower"));
      this.tracks.push(new Track("DKR", "Jungle Falls", 104, 36.43, "Jungle", "Penguin", "DKR"));
      this.tracks.push(new Track("GBA", "Lakeside Park", 105, 53, "Jungle", "Cloud", "Special"));
      this.tracks.push(new Track("", "Wario Circuit", 106, 165.4, "Circuit", "Cloud", "Custom"));
      this.tracks.push(new Track("N64", "Banshee Boardwalk", 107, 35, "Ghost", "Cloud", "Special"));
      this.tracks.push(new Track("", "Creep Sea Cape", 108, 165.45, "Water", "Cloud", "Custom"));
      this.tracks.push(new Track("SNES", "Koopa Beach 2", 109, 17, "Beach", "Grand Star", "Special"));
      this.tracks.push(new Track("", "Green Hill Zone", 110, 165.43, "Unique", "Grand Star", "Custom"));
      this.tracks.push(new Track("", "Cavi Cape Cliffside", 111, 165.47, "Mountain", "Grand Star", "Custom"));
      this.tracks.push(new Track("", "Nabbit's Secret Island", 112, 168.5, "Grass", "Grand Star", "Custom"));
      this.tracks.push(new Track("", "Sky High Cathedral", 113, 177, "Ghost", "Invincibility Leaf", "Custom"));
      this.tracks.push(new Track("", "Shipwreck Shore", 114, 177.1, "Unique", "Invincibility Leaf", "Custom"));
      this.tracks.push(new Track("GPDX", "Bowser's Castle", 115, 120.9, "Lava", "Invincibility Leaf", "GP"));
      this.tracks.push(new Track("N64", "DK's Jungle Parkway", 116, 33, "Jungle", "Invincibility Leaf", "Special"));
      this.tracks.push(new Track("DKR", "Fossil Canyon", 117, 36.42, "Desert", "Heart", "Custom"));
      this.tracks.push(new Track("DS", "DK Pass", 118, 81, "Snow", "Heart", "Star"));
      this.tracks.push(new Track("GBA", "Bowser Castle 4", 119, 55, "Lava", "Heart", "Special"));
      this.tracks.push(new Track("RMX", "Rainbow Road 1", 120, 153, "Space", "Heart", "Tour"));
      this.tracks.push(new Track("", "Moo Moo Mountain", 121, 170.5, "Grass", "Life Mushroom", "Custom"));
      this.tracks.push(new Track("GPDX", "Tropical Coast", 122, 120.35, "Beach", "Life Mushroom", "GP"));
      this.tracks.push(new Track("3DS", "Shy Guy Bazaar", 123, 108, "Desert", "Life Mushroom", "Mushroom"));
      this.tracks.push(new Track("N64", "Bowser's Castle", 124, 32, "Lava", "Life Mushroom", "Special"));
      this.tracks.push(new Track("GP", "Snow Panic", 125, 88.5, "Snow", "Blooper", "GP"));
      this.tracks.push(new Track("SNES", "Mario Circuit 2", 126, 5, "Circuit", "Blooper", "Mushroom"));
      this.tracks.push(new Track("", "Volcanic Skyway", 127, 158.5, "Unique", "Blooper", "Custom"));
      this.tracks.push(new Track("", "Whale Lagoon", 128, 179, "Unique", "Blooper", "Custom"));
      this.tracks.push(new Track("SNES", "Koopa Beach 1", 129, 11, "Beach", "Piranha Plant", "Star"));
      this.tracks.push(new Track("GCN", "Mario Circuit", 130, 62, "Circuit", "Piranha Plant", "Flower"));
      this.tracks.push(new Track("DS", "Desert Hills", 131, 77, "Desert", "Piranha Plant", "Flower"));
      this.tracks.push(new Track("", "Pill Hill Valley", 132, 180, "Grass", "Piranha Plant", "Custom"));
      this.tracks.push(new Track("N64", "Koopa Troopa Beach", 133, 23, "Beach", "Crown", "Mushroom"));
      this.tracks.push(new Track("3DS", "Wario Shipyard", 134, 114, "Water", "Crown", "Star"));
      this.tracks.push(new Track("", "Somnom Labyrinth", 135, 168.6, "Unique", "Crown", "Custom"));
      this.tracks.push(new Track("DKR", "Walrus Cove", 136, 36.46, "Snow", "Crown", "DKR"));
      this.tracks.push(new Track("Wii", "Luigi Circuit", 137, 89, "Circuit", "Multi Moon", "Mushroom"));
      this.tracks.push(new Track("RMX", "Choco Island 1", 138, 152, "Mountain", "Multi Moon", "Tour"));
      this.tracks.push(new Track("", "Boshi's Skatepark", 139, 158.4, "Unique", "Multi Moon", "Custom"));
      this.tracks.push(new Track("", "Windmill Isle", 140, 181, "Unique", "Multi Moon", "Custom"));
      this.tracks.push(new Track("", "Humpback Pump Track", 141, 145.5, "Unique", "Squid", "Custom"));
      this.tracks.push(new Track("", "Area 64", 142, 170.6, "Grass", "Squid", "Custom"));
      this.tracks.push(new Track("", "Cheep Cheep Cove", 143, 168.5, "Water", "Squid", "Custom"));
